...
<body>
	<div class="container-fluid bg-light">
		...
		<div class="container col-md-6">
			<form method="post" action="cek-mahasiswa.php">
				<h2 class="text-uppercase text-center">MASUKAN DATA MAHASISWA</h2><br/>
		...
		<br/><br/><hr><br/><br/>
		<h3 class="text-uppercase text-center">DATA MAHASISWA</h3><br/>
		<div class="container">
		<table class="table">
				...
				<?php
					...
					while ($d = mysqli_fetch_array($data)) {
						...
						<tr>
							...
							<td>
								<a href="form-edit-mahasiswa.php?nim=<?php echo $d['nim']; ?>">EDIT</a>
								<a href="hapus-mahasiswa.php?nim=<?php echo $d['nim']; ?>">HAPUS</a>
							</td>
						</tr>
						<?php
					}
